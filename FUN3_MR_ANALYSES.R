...
library("varhandle")    ## install.packages("varhandle")  - This package is for "unfactor" function ##
...
# ## load libraries for correlation matrix and plot ##
# library("Hmisc")
# library("corrplot")
...
##### ! NOT RUN #####
>>>>>>> 77f06684ff69f7ca9bd28bc86f997cf04e4f306d
